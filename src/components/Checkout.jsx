...
//             "postal-code": formData.postalCode,  // Ensure correct field name
//             city: formData.city,
//           },
//         },
//       })
...
//     //     <div className="violation">
//     //       <h2 className="red-text" style={{ color: "red" }}>Success!</h2>
//     //       <p>Your order was submitted successfully.</p>
...
//     {data && !error && <CartPopup message="Your order was submitted successfully.
//           We will get back to you with more details via email within the next few minutes." onClose={() => setStep(1)} />}
...
export default function Checkout() {
  ...
  function handleFinish() {
    ...
    cartCtx.clearCart();
    clearData();
    setShowSuccessPopup(false); // Hide popup when checkout closes
  }
  ...
  function handleSubmit(event) {
    ...
    setShowSuccessPopup(true); // Show popup after submission
  }
